  ...
  return (
    <div className="flex min-h-screen">
      ...
      <section className="w-full md:w-1/2 bg-[#003F2a] p-12 flex flex-col items-center justify-center">
        ...
        {/* Google login button */}
        <button
          className="bg-white border py-2 rounded-xl mt-5 flex justify-center items-center text-sm hover:scale-101 hover:bg-gray-200 duration-300 text-black w-full max-w-md"
